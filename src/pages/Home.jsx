...
export default function Home() {
        ...
        .then((message) => {
          fetch(`${import.meta.env.VITE_API_BASE_URL}/api/products`, {
            ...
            .catch((error) => {
              console.error("Error fetching products:", error.message);
              alert(
                "Terjadi masalah saat mengambil data produk. Silakan coba lagi."
              );
            });
          alert(message);
        });
  ...
  function saveUpdate() {
    fetch(
      `${import.meta.env.VITE_API_BASE_URL}/api/products/${updateproducttt.id}`,
      {
        method: "PUT",
        headers: {
...
//         //   .then((response) => response.json())
//         //   .then((products) => setproducttts(products));
//         setproducttts([...producttts, data.product]); // gunakan `data.product`
//         if (data.message) {
